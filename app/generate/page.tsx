        ...
        <div className="grid grid-cols-1 mt-14 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-800 p-6 rounded-2xl space-y-6">
              ...
              <Button
                className="bg-blue-600 hover:bg-blue-700 text-white w-full py-2 rounded-full transition-colors"
            ...
            <div className="bg-gray-800 p-6 rounded-2xl space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Button
                  className="bg-gray-700 hover:bg-gray-600 text-white text-sm py-2 px-4 rounded-full transition-colors"
